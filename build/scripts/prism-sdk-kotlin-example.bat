...
set CLASSPATH=%APP_HOME%\lib\prism-sdk-kotlin-example-1.0-SNAPSHOT.jar;%APP_HOME%\lib\kotlin-stdlib-jdk8-1.5.30.jar;%APP_HOME%\lib\kotlin-stdlib-jdk7-1.5.30.jar;%APP_HOME%\lib\kotlinx-datetime-jvm-0.2.1.jar;%APP_HOME%\lib\kotlin-stdlib-1.5.30.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.5.30.jar
